...
<!--[if lt IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/minimaliste/stylesheet/ie6.css" />
...
<div id="header">
  <div class="div1">
    ...
    <div class="div3"><a href="<?php echo str_replace('&', '&amp;', $special); ?>"><?php echo $text_special; ?></a><a onclick="bookmark(document.location, '<?php echo addslashes($title); ?>');"><?php echo $text_bookmark; ?></a><a href="<?php echo str_replace('&', '&amp;', $contact); ?>"><?php echo $text_contact; ?></a><a href="<?php echo str_replace('&', '&amp;', $sitemap); ?>"><?php echo $text_sitemap; ?></a></div>
    <div class="div4">
		<div id="search">
          <div class="div9">
            <?php if ($keyword) { ?>
    ...
    <div class="div5">
	  ...
	  <?php if (!$logged) { ?>
	  <a href="<?php echo str_replace('&', '&amp;', $login); ?>"><?php echo $text_login; ?></a>
	  <?php } else { ?>
	  <a href="<?php echo str_replace('&', '&amp;', $logout); ?>"><?php echo $text_logout; ?></a>
	  <?php } ?>
	  <a href="<?php echo str_replace('&', '&amp;', $account); ?>"><?php echo $text_account; ?></a><a href="<?php echo str_replace('&', '&amp;', $cart); ?>" id="tab_cart"><?php echo $text_cart; ?></a><a href="<?php echo str_replace('&', '&amp;', $checkout); ?>" id="tab_checkout"><?php echo $text_checkout; ?></a>
	</div>
  </div>
  <div class="div6">
